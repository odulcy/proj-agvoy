...
{
    /**
     * @Route("/", name="programmation_circuit_index", methods="GET")
     */
    ...
    /**
     * @Route("/new", name="programmation_circuit_new", methods="GET|POST")
     */
    ...
    /**
     * @Route("/{id}", name="programmation_circuit_show", methods="GET")
     */
    ...
    /**
     * @Route("/{id}/edit", name="programmation_circuit_edit", methods="GET|POST")
     */
    ...
    /**
     * @Route("/{id}", name="programmation_circuit_delete", methods="DELETE")
     */
